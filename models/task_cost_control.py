...
class TaskMaterial(models.Model):
    ...
    state = fields.Selection([
        ...
        ('cancelled',  'Cancelled'),
    ], default='draft', string='Status', copy=False, tracking=False,
...
class ProjectTaskCostControl(models.Model):
    ...
    cost_currency_id = fields.Many2one(
        'res.currency', compute='_compute_cost_currency', string='Currency',
    )
    ...
    labor_count     = fields.Integer(compute='_compute_counts',          string='Labor Lines')
